...
public class Alumno {
    ...
    public static void save(Context context, Alumno alumno) {
            try {
        ...
        public static List<Alumno> getArray(Context context) {
            List<Alumno> array = new ArrayList<Alumno>();
            try {
        ...
        public static Alumno getIndex(int index,Context context)
        {
            try {
                if(DBManager.get(context).getAlumno().queryForEq(ID,index).size() > 0)
                {
                    return DBManager.get(context).getAlumno().queryForEq(ID,index).get(0);
                }
            } catch (SQLException e) {
                e.printStackTrace();
            }
